...
public class BombaController {
    ...
    @PatchMapping("/{bombaId}/enabled")
    public ApiResponse<BombaItemResponse> setEnabled(
            @PathVariable Long bombaId,
            @RequestParam boolean enabled
    ) {
        var updated = bombaService.setEnabled(bombaId, enabled);
        return ApiResponse.success(BombaItemResponse.from(updated, null));
    }
