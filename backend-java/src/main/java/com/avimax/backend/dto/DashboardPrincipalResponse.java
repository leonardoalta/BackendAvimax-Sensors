...
public record DashboardPrincipalResponse(
    ...
    public static record DashboardPrincipalData(
    ...
    public static record ParvadaDashboardData(
    ...
    public static record TelemetriaMinMaxDiaDashboardData(
    ...
    public static record MinMax(
        @JsonProperty("min") Double min,
        @JsonProperty("max") Double max
    ) {
    }

    public static record DashboardMeta(
